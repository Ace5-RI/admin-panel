        ...
        <div class="login-card">
            ...
            <div class="right-panel">
                ...
                <form id="loginForm" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="role-select">
                        <button type="button" class="select-btn active" data-role="admin">Admin</button>
                ...
                <p class="register">Belum Punya Akun <a href="#" id="showRegister"
            ...
            <div class="register-wrapper">
                ...
                <form class="register-form" id="registerForm" method="POST" action="{{ route('register') }}">
                    ...
                    <input type="password" name="password_confirmation" id="regPasswordConfirmation"
